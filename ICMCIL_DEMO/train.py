...
def get_command_line_parser():
    ...
    parser.add_argument('-result_name', type=str, default=PROJECT)
    parser.add_argument('-result_path', type=str, default=PROJECT)
    parser.add_argument('-dataset', type=str, default='LasHeR_CL',
                        choices=['mini_imagenet', 'LasHeR_CL', 'VTDV_CL', 'cub200', 'cifar100'])
    parser.add_argument('-dataroot', type=str, default=DATA_DIR)
    parser.add_argument('-dataroot_i', type=str, default=DATA_DIR)
