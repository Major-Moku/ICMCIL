...
class VTDV_CL(Dataset):
    ...
    def __init__(self, root='/data', train=True,
        ...
        self.IMAGE_PATH = os.path.join(root, 'VTDV_CL/images')
        self.SPLIT_PATH = os.path.join(root, 'VTDV_CL/split')
...
if __name__ == '__main__':
    ...
    batch_size_base = 2752
    trainset = VTDV_CL(root=dataroot, train=True, transform=None, index_path=txt_path)
