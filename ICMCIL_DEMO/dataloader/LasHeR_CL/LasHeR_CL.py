...
class LasHeR_CL(Dataset):
    ...
    def __init__(self, root='/data', train=True,
        ...
        self.IMAGE_PATH = os.path.join(root, 'LasHeR_CL/images')
        self.SPLIT_PATH = os.path.join(root, 'LasHeR_CL/split')
...
class LasHeR_CL_concate(Dataset):
...
if __name__ == '__main__':
    ...
    txt_path = args.dataroot + "/index_list/" + args.dataset + "/session_1" + '.txt'
    # class_index = open(txt_path).read().splitlines()
    base_class = 10
    class_index = np.arange(base_class)
    dataroot = args.dataroot
    batch_size_base = 1315
    trainset = LasHeR_CL(root=dataroot, train=True, transform=None, index_path=txt_path)
